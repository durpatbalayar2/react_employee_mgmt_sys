...
const EmpTaskCard = () => {
  return (
    <div
      id="tasklist"
      className=" flex items-center justify-start flex-nowrap gap-5 w-full   h-[50%] mt-10 overflow-x-auto"
    >
      <div className=" shrink-0 h-full w-75 bg-red-400 rounded-xl">
        ...
        <p className="text-xl px-3 mt-5">
          ...
          quis sapiente veniam molestias est?
        </p>
      </div>
      ...
      <div className=" shrink-0 h-full w-75 bg-gray-400 rounded-xl">
        <div className="flex items-center justify-between px-3 py-4">
          <h3 className="bg-red-600 px-5 py-1 rounded-lg text-base">High</h3>
          <h4 className="text-sm">20 feb 2024</h4>
        </div>
      ...
      <div className=" shrink-0 h-full w-75 bg-blue-400 rounded-xl">
        <div className="flex items-center justify-between px-3 py-4">
          <h3 className="bg-red-600 px-5 py-1 rounded-lg text-base">High</h3>
          <h4 className="text-sm">20 feb 2024</h4>
        </div>
